...
const htrRouter = new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      component: () =>
        import(
          /* webpackChunkName: "characters-list" */ './views/Characters/CharactersList.vue'
        )
    },
    {
      ...
      component: () =>
        import(
          /* webpackChunkName: "characters-view" */ './views/Characters/CharactersView.vue'
        ),
    ...
    },
    {
      ...
      component: () =>
        import(
          /* webpackChunkName: "series-list" */ './views/Series/SeriesList.vue'
        )
    },
    {
      ...
      component: () =>
        import(
          /* webpackChunkName: "series-view" */ './views/Series/SeriesView.vue'
        ),
      props: { isCreate: false }
    },
    {
    ...
    },
    {
      ...
      component: () =>
        import(
          /* webpackChunkName: "versus-comparison" */ './views/Versus/VersusComparison.vue'
        )
    },
    {
      ...
      component: () =>
        import(
          /* webpackChunkName: "versus-creator" */ './views/Versus/VersusCreator.vue'
        )
    },
    {
      ...
      component: () =>
        import(
          /* webpackChunkName: "template-list" */ './views/HTRTemplates/HTRTemplateList.vue'
        )
    },
    {
      ...
      component: () =>
        import(
          /* webpackChunkName: "htr-template-creator" */ './views/HTRTemplates/HTRTemplateCreator.vue'
        ),
      props: { isCreate: true }
    },
    {
    ...
    },
    {
      ...
      component: () =>
        import(
          /* webpackChunkName: "instance-list" */ './views/HTRInstances/HTRInstanceList.vue'
        )
    },
    {
      ...
      component: () =>
        import(
          /* webpackChunkName: "instance-view" */ './views/HTRInstances/HTRInstanceView.vue'
        ),
      props: { isCreate: true }
    },
    {
    ...
    },
    {
      ...
      component: () =>
        import(
          /* webpackChunkName: "instance-league-center" */ './views/HTRInstances/HTRInstanceLeagueCenter.vue'
        )
    },
    {
      ...
      component: () =>
        import(
          /* webpackChunkName: "instance-league-view" */ './views/HTRInstances/HTRInstanceLeagueView.vue'
        )
    },
    {
      ...
      component: () =>
        import(
          /* webpackChunkName: "ranking-list" */ './views/Rankings/RankingsList.vue'
        )
    },
    {
      path: Urls.gauntlet,
